...
{cards_html}
  ...
  <h2>Going deeper</h2>
  <p>For the complete picture — your specific Birth, Name and Life Path numbers in your own chart, plus a 5-year personal-year forecast, name-correction options and remedies — the <a href="/report">Full Destiny Report (INR 199/-)</a> generates a personalised PDF in 60 seconds.</p>
