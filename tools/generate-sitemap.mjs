...
function priorityFor(route) {
  ...
  if (['/analyzer', '/name-numerology-calculator', '/name-alignment', '/love-compatibility-numerology', '/ask-aura', '/numerology-spiritual-meaning', '/numerology-and-overthinking', '/numerology-love-styles', '/lucky-attributes', '/lo-shu-grid-calculator', '/mobile-number-numerology', '/link-to-us'].includes(route)) return '0.9';
