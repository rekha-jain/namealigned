...
.nc-hero h1{{font-family:'Playfair Display',Georgia,serif;font-size:clamp(28px,4.2vw,42px);line-height:1.2;margin:0 auto .5rem;max-width:780px;}}
...
.nc-tldr{{max-width:780px;margin:1.25rem auto 0;padding:1.1rem 1.4rem;background:linear-gradient(135deg,rgba(240,180,41,.10),rgba(157,127,255,.10));border:1px solid rgba(240,180,41,.32);border-radius:12px;font-family:sans-serif;font-size:14px;line-height:1.65;color:var(--text);}}
.nc-tldr strong{{color:var(--gold-d);}}
...
<header class="nc-hero">
  <div class="container">
    ...
    <h1>Best Careers for Number {n} — The {archetype}</h1>
    <div class="tag">{base["tagline"]}</div>
  </div>
  <div class="nc-tldr"><strong>TL;DR.</strong> {tldr}</div>
</header>
