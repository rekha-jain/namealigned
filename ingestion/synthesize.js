...
const TRADITIONS = {
  ...
  tarot_major_arcana: {
    label: 'Tarot Major Arcana (Rider-Waite-Smith tradition, public domain since 1909)',
    framework: [
      'The 22 Major Arcana of the tarot, as taught in the Rider-Waite-Smith system',
      '(public domain since 1909). Each card represents a universal archetype or life',
      'situation. Core cards: The Fool (new beginnings, leap of faith), The Magician',
      '(focused will, manifestation), The High Priestess (inner knowing, intuition),',
      'The Empress (creative abundance, nurturing), The Emperor (structure, authority),',
      'The Hierophant (tradition, teaching), The Lovers (choice, union), The Chariot',
      '(determined will, victory through control), Strength (inner courage, gentleness),',
      'The Hermit (withdrawal, inner counsel), Wheel of Fortune (cycles, change of luck),',
      'Justice (balance, accountability), The Hanged Man (surrender, new perspective),',
      'Death (ending, transformation, not literal death), Temperance (integration, blending),',
      'The Devil (attachment, illusion of being trapped), The Tower (sudden revelation,',
      'collapse of false structure), The Star (hope after crisis, healing), The Moon',
      '(uncertainty, things hidden, intuition under stress), The Sun (clarity, vitality,',
      'joy), Judgement (calling, reckoning, awakening), The World (completion,',
      'integration, end of a chapter).',
      'IMPORTANT: When authoring cards, NEVER name the tarot card by its title in the body',
      '(no "The Hermit", no "The Tower"). Translate the archetype directly into the felt',
      'emotional pattern. The card name (in the name field) can reference it, but the body',
      'must speak only in plain emotional English.',
    ].join(' '),
    topic_seeds: [
      'Fool: standing at the edge of a big choice',
      'Magician: scattered effort, time to focus',
      'High Priestess: inner knowing the mind is ignoring',
      'Empress: creative or maternal abundance',
      'Emperor: needing structure or boundaries',
      'Hierophant: longing for a teacher or framework',
      'Lovers: a real choice point in love or values',
      'Chariot: forcing things forward by will alone',
      'Strength: gentling something that wants to be controlled',
      'Hermit: withdrawing to find your own counsel',
      'Wheel of Fortune: a cycle turning, beyond your control',
      'Justice: a moment of accounting and fairness',
      'Hanged Man: a deliberate pause, surrender',
      'Death: an ending that frees, not a feared event',
      'Temperance: blending opposites in yourself',
      'Devil: an attachment that feels inescapable',
      'Tower: a sudden collapse that ultimately frees',
      'Star: gentle return of hope after a hard time',
      'Moon: ambiguity, the mind making fears feel real',
      'Sun: clarity and vitality returning',
      'Judgement: a calling, a reckoning, an awakening',
      'World: a chapter genuinely complete',
    ],
  },
